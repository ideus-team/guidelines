 ...
 * js — для jQuery-хуков
4. Сокращенные модификаторы через multiple classes `class="b-blockName__elementName -modifier_value"`.
Стили модификаторов не пишутся без привязки к имени блока `.b-block_modifier_value {} = .b-block.-modifier_value {}`
5. Синтаксис вида: `.b-blockName__elementName.-modifier_value {}`
 ...
 * Модификаторы утяжеляют вес селекторов, за 9 лет проблем ни разу не было.
